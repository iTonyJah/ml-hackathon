...
ML_FEATURE_COLUMNS = [
    ...
    "task_apply_rate",
    "task_finish_rate",
    "task_view_without_apply_rate",
    "employer_view_cnt",
    "employer_apply_cnt",
    "employer_finished_cnt",
    "employer_apply_rate",
    "employer_finish_rate",
    "employer_view_without_apply_rate",
    "workplace_view_cnt",
    "workplace_apply_cnt",
    "workplace_finished_cnt",
    "workplace_apply_rate",
    "workplace_finish_rate",
    "workplace_view_without_apply_rate",
    "rule_score",
]
